        ...
        <div class="row">
            <div class="col-12  align-self-center">
                <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                    ...
                    <ol class="breadcrumb abg-transparent align-self-center m-0 p-0">
            ...
            <div class="col-12  col-md-6 col-lg-3 mt-3">
                <div class="card border-bottom-0">
                    <div class="card-content border-bottom border-primary border-w-5">
                        <div class="card-body p-4">
                            <div class="d-flex">
                                <img src="{{ asset('backend/assets/images/author1.jpg') }}" alt="author" width="55"
                    ...
                    <div class="card-content border-bottom border-warning border-w-5">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex">
                                ...
                                <img src="{{ asset('backend/assets/images/author9.jpg') }}" alt="author" width="30"
                                    class="rounded-circle  ml-auto">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-bottom-0 mt-3">
                    <div class="card-content border-bottom border-info border-w-5">
                        <div class="card-body p-4">
                            <div class="d-flex">
                                <img src="{{ asset('backend/assets/images/author9.jpg') }}" alt="author" width="55"
                                    class="rounded-circle  ml-auto">
                                <div class="media-body align-self-center pl-3">
                            ...
                            <ul class="list-group list-unstyled">
                                <li class="p-2 border-bottom zoom">
                                    <div class="media d-flex w-100">
                                        <a href="#"><img src="{{ asset('backend/assets/images/author1.jpg') }}"
                                                alt="" class="img-fluid ml-0 mt-2  rounded-circle"
                                                width="40"></a>
                                ...
                                <li class="p-2 border-bottom zoom">
                                    <div class="media d-flex w-100">
                                        <a href="#"><img src="{{ asset('backend/assets/images/author2.jpg') }}"
                                                alt="" class="img-fluid ml-0 mt-2  rounded-circle"
                                                width="40"></a>
                                        <div class="media-body align-self-center pl-2">
                                            <span class="mb-0 font-w-600">kelvin</span><br>
                                ...
                                <li class="p-2 border-bottom zoom">
                                    <div class="media d-flex w-100">
                                        <a href="#"><img src="{{ asset('backend/assets/images/author3.jpg') }}"
                                                alt="" class="img-fluid ml-0 mt-2 rounded-circle"
                                                width="40"></a>
                                        <div class="media-body align-self-center pl-2">
                                ...
                                <li class="p-2 border-bottom zoom">
                                    <div class="media d-flex w-100">
                                        <a href="#"><img src="{{ asset('backend/assets/images/author9.jpg') }}"
                                                alt="" class="img-fluid ml-0 mt-2 rounded-circle"
                                                width="40"></a>
                                        <div class="media-body align-self-center pl-2">
                                ...
                                <li class="p-2 border-bottom zoom">
                                    <div class="media d-flex w-100">
                                        <a href="#"><img src="{{ asset('backend/assets/images/author6.jpg') }}"
                                                alt="" class="img-fluid ml-0 mt-2 rounded-circle"
                                                width="40"></a>
                                        <div class="media-body align-self-center pl-2">
                                ...
                                <li class="p-2 zoom">
                                    <div class="media d-flex w-100">
                                        <a href="#"><img src="{{ asset('backend/assets/images/author7.jpg') }}"
                                                alt="" class="img-fluid ml-0 mt-2 rounded-circle"
                                                width="40"></a>
                                        <div class="media-body align-self-center pl-2">
                ...
                <div class="card border">
                    <div class="card-content">
                        <div class="card-body p-4">
                            <div class="d-md-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('backend/assets/images/wallet.png') }}" alt="author"
                                        width="48" class="my-auto">
                                </div>
                                <div class="content px-md-3 my-3 my-md-0">
                                    <span class="mb-0 font-w-600 h5">Lorem ipsum dolor sit</span><br>
                                    <p class="mb-0 font-w-500 tx-s-12">Lorem ipsum dolor sit amet, consectetuer adipiscing
                ...
                <div class="card outline-badge-primary">
                    <div class="card-content">
                        <div class="card-body p-4">
                            <div class="d-md-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('backend/assets/images/money.png') }}" alt="author"
                                        class="my-auto">
                                </div>
                                <div class="content px-md-3 my-3 my-md-0">
                                    <span class="mb-0 font-w-600 h5">Lorem ipsum dolor sit</span><br>
                                    ...
                                    <ul class="tasks">
                                        <li class="outline-badge-success border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                ...
                                                <img src="{{ asset('backend/assets/images/author.jpg') }}" alt="author"
                                                    width="30" height="30" class="rounded-circle" />
                                                <img src="{{ asset('backend/assets/images/author2.jpg') }}"
                                                    alt="author" width="30" height="30"
                                        ...
                                        <li class="outline-badge-warning border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                ...
                                                <img src="{{ asset('backend/assets/images/author2.jpg') }}"
                                                    alt="author" width="30" height="30"
                                                    class="rounded-circle " />
                                                <img src="{{ asset('backend/assets/images/author3.jpg') }}"
                                                    alt="author" width="30" height="30"
                                                    class="rounded-circle" />
                                        ...
                                        <li class="outline-badge-info border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                ...
                                                <img src="{{ asset('backend/assets/images/author3.jpg') }}"
                                                    alt="author" width="30" height="30"
                                                    class="rounded-circle " />
                                                <img src="{{ asset('backend/assets/images/author7.jpg') }}"
                                                    alt="author" width="30" height="30"
                                                    class="rounded-circle" />
                                                <span class="mb-0 ml-2 my-auto font-w-600">Cras dapibus vivamus elementum
                                                    semper nisi.</span>
                                        ...
                                        <li class="outline-badge-secondary border-0 d-flex py-3 px-2 zoom">
                                            <label class="chkbox d-flex">
                                                <input type="checkbox">
                                                <img src="{{ asset('backend/assets/images/author6.jpg') }}"
                                                    alt="author" width="30" height="30"
                                                    class="rounded-circle " />
                                                <img src="{{ asset('backend/assets/images/author8.jpg') }}"
                                                    alt="author" width="30" height="30"
                                                    class="rounded-circle" />
                                                <span class="mb-0 ml-2 my-auto font-w-600">Donec quam felis ultricies nec,
                                ...
                                <div class="col-12">
                                    <ul class="activities mt-3 mb-2">
                                        <li class="activity py-2 border-left">
                                            ...
                                            <div class="d-flex">
                                                <div>
                                                    <img src="{{ asset('backend/assets/images/photoshop.png') }}"
                                        ...
                                        <li class="activity py-3 border-left">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <img src="{{ asset('backend/assets/images/portfolio1.jpg') }}"
                                                    alt="photoshop" width="100" class="img-responsive rounded">
                                                <img src="{{ asset('backend/assets/images/portfolio2.jpg') }}"
                                                    alt="photoshop" width="100" class="img-responsive rounded ml-2">
            ...
            <div class="col-12  col-md-6 col-lg-4 mt-3">
                ...
                <div class="card promoting-card">
                    ...
                    <div class="card-body d-flex flex-row">
                        ...
                        <!-- Avatar -->
                        <img src="{{ asset('backend/assets/images/author1.jpg') }}" class="rounded-circle mr-3"
                    ...
                    <div class="view overlay">
                        <img class="card-img-top rounded-0" src="{{ asset('backend/assets/images/portfolio13.jpg') }}"
                            alt="Card image cap">
